  ...
  var __sp = S.prototype = {
    ...
    replaceAll: function(ss, r) {
      ...
      return new S(s);
        ...
        replaceMultiple: function(ss,r){
      //console.log("REPLACE");
      //console.log(ss.isArray())
      ...
      if(isArray(ss)){
        if(isArray(r)){
          for(var k=0;k<ss.length;++k){
            this.s=this.s.replaceAll(ss[k],r[k]);
          }
        }else{
          for(var k=0;k<ss.length;++k){
            this.s=this.replaceAll(ss[k],r);
          }
        }
        return new S(this.s);
      }else{
        return this.replaceAll(ss,r);
      }
    },
    ...
    replaceMultiple: function(ss,r){
      ...
      if(isArray(ss)){
        if(isArray(r)){
          for(var k=0;k<ss.length;++k){
            this.s=this.replaceAll(ss[k],r[k]);
          }
        }else{
          for(var k=0;k<ss.length;++k){
            this.s=this.replaceAll(ss[k],r);
